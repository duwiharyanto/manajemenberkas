      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="{{url('Cariberkas')}}">Berkas <span class="sr-only">(current)</span></a></li>
          </ul>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            @else
              <li><a href="{{url('Login')}}"> <span class="fa fa-lock"></span> Login</a></li>            
            @endif
